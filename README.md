...
- ホーム: Yahoo!天気を参考にした高密度レイアウト。上部に保存地点タブ、今日/明日の2列比較、同一横スクロール内に揃えた時刻・天気・気温・降水確率・雨量・湿度・風、日の出/日の入、現在値、現在地の雨雲レーダープレビュー、直近3時間、2週間一覧を集約。黒と濃紺を基調に、最高気温は赤、最低気温は青、降水は水色で統一。天気アイコンはグレーの雲を基調に、晴れはオレンジ、雨は青、雷は黄を重ねた共通ベクター表示。週間行を押すとAM/PMを含む詳細を表示
